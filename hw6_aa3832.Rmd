...
I can safely say I've never seen p values this low.  Incredible!  The R-squared value here is quite high at 0.912 suggesting this simple linear regression is a good fit for these data.

Here we will use the bootstrapping method for the R^2^ value.
